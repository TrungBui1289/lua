...
local PresetColor = Color3.fromRGB(108, 1, 108)
...
HunterLib.Parent = game.CoreGui
HunterLib.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

coroutine.wrap(
	function()
		while wait() do
			Hunter.RainbowColorValue = Hunter.RainbowColorValue + 1 / 255
			Hunter.HueSelectionPosition = Hunter.HueSelectionPosition + 1

			if Hunter.RainbowColorValue >= 1 then
				Hunter.RainbowColorValue = 0
			end

			if Hunter.HueSelectionPosition == 80 then
				Hunter.HueSelectionPosition = 0
			end
		end
	end
)()
...
function Hunter:Window(text, bottom,mainclr,toclose)
	...
	Title.Position = UDim2.new(0.057560972, 0, 0.0475206636, 0)
	...
	BottomText.Position = UDim2.new(0.057560972, 0, 0.0989999792, 0)
	...
	function Hunter:Notification(desc,buttontitle)
	...
	function Tabs:Tab(text,ico)
				...
				function()
					...
					if RainbowColorPicker then
						...
						while RainbowColorPicker do
							BoxColor.BackgroundColor3 = Color3.fromHSV(Hunter.RainbowColorValue, 1, 1)
							Color.BackgroundColor3 = Color3.fromHSV(Hunter.RainbowColorValue, 1, 1)

							ColorSelection.Position = UDim2.new(1, 0, 0, 0)
							HueSelection.Position = UDim2.new(0.48, 0, 0, Hunter.HueSelectionPosition)
		...
		function ContainerContent:Label(text)
			...
			Label.Size = UDim2.new(0, 228, 0, 43)
